...
/*#__PURE__*/
function () {
  function SummarySection(fields) {
  ...
  _createClass(LoadCheckoutPage, [{
    ...
    value: function perform() {
      ...
      fetch(url).then(function (result) {
        ...
        console.log('this', _this3.voucher_id);

        if (_this3.voucher_id != -1) {
          fields = _objectSpread({}, fields, {
            hasVoucher: true,
            voucher_id: _this3.voucher_id
          });
        }

        var summarySection = new SummarySection(fields);
        var cupomSection = new CupomSection(fields.cupons);
